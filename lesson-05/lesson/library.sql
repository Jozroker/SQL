...
INSERT INTO book(`name`, price, isbn, book_category_id) VALUES 
	('Emma', 139.7, '978-5-0397-92', 1),
...
INSERT INTO author(first_name, last_name, date_of_birthday) VALUES 
	('Jane', 'Austen', '1974-02-18'),
...
SELECT book.id, book.`name`, price, bc.`name` category, a.first_name author_f_name, a.last_name author_l_name from book
...
SELECT a.first_name author_f_name, a.last_name author_l_name, b.name book, bc.name category from author a
...
WHERE a.first_name = 'Stephen' AND a.last_name = 'Hawking';

SELECT b.name book, a.first_name author_f_name, a.last_name author_l_name, bc.name category from author a
LEFT JOIN book_author ba
	ON ba.author_id = a.id
JOIN book b
	ON b.id = ba.book_id
