...
INSERT INTO courier(first_name, last_name, age) VALUES
	('Roy', 'Firkins', 23),
	('Walter', 'Goodale', 38),
	('Marc', 'Vanover', 20),
	('Edwin', 'Tolbert', 31);
	
INSERT INTO customer(first_name, last_name, age, phone_number) VALUES
	('Mary', 'Collins', 49, '0861881971'),
...
INSERT INTO firm(`name`, country_id) VALUES
	('Dell', 1),
	('HyperX', 1),
	('Bosch', 3),
	('LG', 4),
...
INSERT INTO shop(`name`, address, email, site) VALUES
	('Best Buy', NULL, NULL,'www.bestbuy.com'),
...
INSERT INTO product(category_id, firm_id, model, price) VALUES
	(2, 1, 'KB-216', 12.5),
...
INSERT INTO delivery(delivery_time, courier_id) VALUES
	('00 days 08 hours 34 minutes', 3),
	('02 days 03 hours 00 minutes', 1),
	('00 days 04 hours 12 misutes', 4),
	('00 days 23 hours 03 minutes', 2);
	
INSERT INTO `order`(`date`, `time`, product_id, product_qty, order_agreement, customer_id, delivery_id) VALUES
	('2020-03-15', '06:36:41', 1, 1, TRUE, 1, NULL),
...
SELECT o.id, `date`, `time`, f.name frim, p.model, p.price, cat.name category, product_qty, c.first_name customer_f_name, c.last_name customer_l_name, c.phone_number,
	 d.delivery_time, co.first_name courier_f_name, co.last_name courier_l_name FROM `order` o
LEFT JOIN product p
...
WHERE order_agreement = TRUE ORDER BY o.id;