...
SELECT * FROM book WHERE sheets_qty > 150;
SELECT * FROM book WHERE author_age > 30;
#SELECT * FROM book WHERE author_prizes = NULL; #all author haven't prizes
SELECT * FROM book WHERE author_email = 'scottwalter@gmail.com';
SELECT * FROM book WHERE isbn = '0-1717-1657-4'; 
SELECT * FROM book WHERE category = 'novel';
SELECT * FROM book WHERE sheets_qty > 200 AND author_age > 25;
SELECT * FROM book WHERE category = 'comedy' OR category = 'romance';
SELECT * FROM book ORDER BY book_name;
SELECT * FROM book ORDER BY author_email;
SELECT * FROM book ORDER BY sheets_qty DESC;
